<?php
    ...
    <div class="dts updated">
        <p>
            <strong><?php _e('Thanks for upgrading! We\'ve compeltely rewritten Device Theme Switcher and added lots of new goodies! Read about the changes <a href="http://wordpress.org/plugins/device-theme-switcher/faq/" target="_blank">here</a>.') ?></strong>
        </p>
    </div><?php
