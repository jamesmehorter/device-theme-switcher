<?php
    class DTS_Shortcode {
        ...
        function link_to_full_website_shortcode( $atts ) {
        ...
        function link_back_to_device_shortcode( $atts ) {
            ...
            //Use our own template tag to generate the shortcode output
            //This function is located in /inc/inc.template-tags.php
            return  link_back_to_device($link_text, $css_classes, false);
